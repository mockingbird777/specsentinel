...
<section class="findings">${rows || '<div class="empty">\u2713 No incompatible changes found.</div>'}</section></main><script type="application/json" id="specsentinel-data">${data}</script></body></html>`;
}
