...
<section class="findings">${rows || '<div class="empty">✓ No breaking or security-sensitive changes found.</div>'}</section><p class="source">Generated locally · <a href="https://github.com/mockingbird777/specsentinel" target="_blank" rel="noopener noreferrer">Explore SpecSentinel on GitHub ↗</a></p></main><script type="application/json" id="specsentinel-data">${data}</script></body></html>`;
}
